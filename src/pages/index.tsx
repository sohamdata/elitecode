    ...
    <main className="bg-dark-layer-2 h-screen">
      ...
      <div className='mt-6 mx-5 px-4 sm:px-[10vw]'>
        <table className='w-full text-left max-w-[1200px] mx-auto text-sm text-gray-400'>
          <caption className='mb-4 text-2xl'>Problems</caption>
          <thead className='border-b uppercase'>
            <tr>
              <th className='px-1 py-3 font-medium'>Status</th>
              <th className='px-1 py-3 font-medium'>Title</th>
              <th className='px-1 py-3 font-medium'>Difficulty</th>
              <th className='px-1 py-3 font-medium'>Category</th>
              <th className='px-1 py-3 font-medium'>Solution</th>
            </tr>
          </thead>
          <tbody>
